...
//---------------
//Bower components
gulp.task('build.bower.js.dev', tasks('build.bower.js.dev'));
gulp.task('build.bower.fonts.dev', tasks('build.bower.fonts.dev'));
gulp.task('build.bower.css.dev', tasks('build.bower.css.dev'));
gulp.task('build.bower.dev', function (done) {
  runSequence('build.bower.js.dev', 'build.bower.fonts.dev', 'build.bower.css.dev', done);
});


gulp.task('build.js.dev', tasks('build.js.dev'));
gulp.task('build.assets.img.dev', tasks('build.assets.img.dev'));
...
gulp.task('build.app.dev', function (done) {
  runSequence('clean.app.dev', 'build.assets.dev', 'build.assets.img.dev', 'build.index.dev', 'build.bower.dev', done);
});
gulp.task('build.dev', function (done) {
  runSequence('clean.dev', 'build.lib.dev', 'build.assets.img.dev', 'build.bower.dev', 'build.app.dev', done);
});
